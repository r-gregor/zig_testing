...
pub fn main() void {
    ...
    // const zen12_string: []const u8 = zen_manyptr; // original
    const zen12_string: []const u8 = zen_manyptr[0..21]; // from https://github.com/wooster0/ziglings/blob/main/exercises/054_manypointers.zig
